...
@Component
public class MinuteIn45Scheduel extends BaseScheduel{
	@Scheduled(cron="0 45 * * * ?")
	public void in5Minite(){
		log.info("In 45 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN45.toString());
