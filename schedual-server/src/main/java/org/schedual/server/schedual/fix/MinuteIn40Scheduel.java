...
@Component
public class MinuteIn40Scheduel extends BaseScheduel{
	@Scheduled(cron="0 40 * * * ?")
	public void in5Minite(){
		log.info("In 40 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN40.toString());
