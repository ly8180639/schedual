...
@Component
public class MinuteIn15Scheduel extends BaseScheduel{
	@Scheduled(cron="0 15 * * * ?")
	public void in5Minite(){
		log.info("In 15 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN15.toString());
