...
@Component
public class MinuteIn30Scheduel extends BaseScheduel{
	@Scheduled(cron="0 30 * * * ?")
	public void in5Minite(){
		log.info("In 30 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN30.toString());
