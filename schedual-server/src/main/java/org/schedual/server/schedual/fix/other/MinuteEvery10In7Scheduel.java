...
@Component
public class MinuteEvery10In7Scheduel extends BaseScheduel{
	@Scheduled(cron="0 7/10 * * * ?")
	public void every10In2minute(){
		log.info("Every 10 Minite In 7 Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN10_7.toString());
