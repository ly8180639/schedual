...
@Component
public class MinuteIn50Scheduel extends BaseScheduel{
	@Scheduled(cron="0 50 * * * ?")
	public void in5Minite(){
		log.info("In 50 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN50.toString());
