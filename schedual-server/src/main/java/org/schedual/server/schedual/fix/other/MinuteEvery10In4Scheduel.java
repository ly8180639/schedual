...
@Component
public class MinuteEvery10In4Scheduel extends BaseScheduel{
	@Scheduled(cron="0 4/10 * * * ?")
	public void every10In4minute(){
		log.info("Every 10 Minite In 4 Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN10_4.toString());
