...
@Component
public class MinuteIn25Scheduel extends BaseScheduel{
	@Scheduled(cron="0 25 * * * ?")
	public void in5Minite(){
		log.info("In 25 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN25.toString());
