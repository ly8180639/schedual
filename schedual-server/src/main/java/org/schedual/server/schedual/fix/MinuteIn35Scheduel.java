...
@Component
public class MinuteIn35Scheduel extends BaseScheduel{
	@Scheduled(cron="0 35 * * * ?")
	public void in5Minite(){
		log.info("In 35 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN35.toString());
