...
@Component
public class MinuteEvery10In1Scheduel extends BaseScheduel{
	@Scheduled(cron="0 1/10 * * * ?")
	public void every10In1minute(){
		log.info("Every 10 Minite In 1 Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN10_1.toString());
