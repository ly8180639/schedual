...
@Component
public class MinuteIn05Scheduel extends BaseScheduel{
	@Scheduled(cron="0 5 * * * ?")
	public void in5Minite(){
		log.info("In 5 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN5.toString());
