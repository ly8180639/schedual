...
@Component
public class MinuteIn10Scheduel extends BaseScheduel{
	@Scheduled(cron="0 10 * * * ?")
	public void in5Minite(){
		log.info("In 10 Minite Scheduel");
		Calendar l=Calendar.getInstance();
		Set<Task> tasks=TaskPoolManager.getScheduel_task_pool().get(FixMinute.FIXIN10.toString());
